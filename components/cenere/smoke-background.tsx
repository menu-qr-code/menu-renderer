...
class Renderer {
  ...
  private color: [number, number, number] = [0.784, 0.663, 0.494]
...
export const SmokeBackground: React.FC<SmokeBackgroundProps> = ({ smokeColor = "#c8a97e" }) => {
